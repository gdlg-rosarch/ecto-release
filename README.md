...
The packages in the `ecto` repository were released into the `lunar` distro by running `/usr/bin/bloom-release --rosdistro lunar --track lunar ecto` on `Wed, 31 May 2017 20:26:13 -0000`
...
## ecto (indigo) - 0.6.12-0

The packages in the `ecto` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --track indigo --rosdistro indigo ecto` on `Sun, 17 Apr 2016 12:40:40 -0000`
...
The packages in the `ecto` repository were released into the `jade` distro by running `/usr/bin/bloom-release --track jade --rosdistro jade ecto` on `Mon, 21 Sep 2015 07:01:01 -0000`
